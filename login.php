...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        // Verifikasi password dengan password_verify (cocok dengan PASSWORD_BCRYPT saat register)
...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .container { width:100%;max-width:440px;animation:fadeUp 0.7s ease both; }
        ...
        .alert-error {
            ...
            padding:0.85rem 1rem;color:var(--error);font-size:0.875rem;
        ...
        input:focus { outline:none;border-color:var(--green-accent);box-shadow:0 0 0 3px rgba(82,183,136,0.15); }
        ...
        .forgot-link a { font-size:0.8rem;color:var(--green-mid);text-decoration:none; }
        ...
        .register-link { text-align:center;margin-top:1.5rem;font-size:0.875rem;color:var(--text-light); }
        .register-link a { color:var(--green-mid);font-weight:500;text-decoration:none; }
        ...
        @media (max-width:480px) { .card{padding:2rem 1.25rem} .brand h1{font-size:2rem} }
    </style>
</head>
<body>
